...
const getLocalStorage = () => JSON.parse(localStorage.getItem('db_medic')) ?? []
const setLocalStorage = (dbMedic) => localStorage.setItem("db_medic", JSON.stringify(dbMedic))

// CRUD - create read update delete
const deleteMedic = (index) => {
    const dbMedic = readMedic()
    dbMedic.splice(index, 1)
...
// Eventos
document.getElementById('cadastrarMedico')
